        ...
        <CardContent className="space-y-4">
          ...
          {equipment.photos && equipment.photos.length > 0 && (
            <div className="flex overflow-x-auto gap-2 pb-2">
              {equipment.photos.map((photoUrl, index) => (
          ...
          {/* Botões de ação (Nova Foto e Lixeira) - FORA da condicional das fotos */}
          <motion.div 
          ...
          >
            ...
            >
              ...
              {equipment.photos && equipment.photos.length > 0 ? 'Nova Foto' : 'Adicionar Foto'}
            </Button>
